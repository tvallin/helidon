...
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.PROMPT_ARGUMENT_DESCRIPTION;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.PROMPT_ARGUMENT_NAME;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.PROMPT_DESCRIPTION;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.PROMPT_NAME;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.RESOURCE_DESCRIPTION;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.RESOURCE_NAME;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.RESOURCE_URI;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.SERVER_NAME;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.SERVER_VERSION;
import static io.helidon.integrations.mcp.tests.McpWeatherServerSe.TOOL_NAME;
...
class AnthropicClientTest {
	...
	void testResourceCall() {
		...
		assertThat(content.mimeType(), is("plain/text"));
